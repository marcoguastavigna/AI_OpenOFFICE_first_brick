...
# ==============================================================================
# OLLAMA MACOS QUICK ACTION: PROMPT IMMAGINE
#
# Crea una Quick Action in Automator chiamata "Ollama Prompt Immagine"
...
MODEL="gemma3:4b" 
PROMPT_PREFIX="Analizza il seguente testo e descrivi un'immagine visiva dettagliata che lo rappresenti. La descrizione deve essere un prompt efficace per un generatore di immagini AI (come Midjourney o Stable Diffusion). Includi dettagli su stile, illuminazione, colori e composizione. Scrivi il prompt in Inglese:"
